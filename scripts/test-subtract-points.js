// Test script to subtract points and verify negative points work
...
async function testSubtractPoints() {
  try {
    ...
    console.log('📊 Before subtracting points:');
    ...
    // Subtract 5 points with completedToday = false (wrong answer)
    console.log('➖ Subtracting 5 points with completedToday = false (wrong answer)...\n');
    ...
    console.log(`   Current Streak: ${updatedUser.streak?.currentStreak || 0} (should be 0)`);
